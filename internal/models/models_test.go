...
// doc against drifting from the prose RenderMarkdown emits. Only the constant
// tail (from "## Model Resolution Order") is compared: the model table above it
// is account-specific and regenerated by the proxy from the live list.
func TestRenderMarkdownMatchesCommittedDoc(t *testing.T) {
	const marker = "## Model Resolution Order"
